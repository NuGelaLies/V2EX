...
extension UIBarButtonItem {
    ...
    public convenience init(image: UIImage?, style: UIBarButtonItem.Style = .plain, action: (() -> Void)? = nil) {
    ...
    public convenience init(title: String?, style: UIBarButtonItem.Style = .plain, action: (() -> Void)? = nil) {
